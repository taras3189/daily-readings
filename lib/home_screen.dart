                  ...
                  child: TabBarView(
                    children: [
                      RichText(
                        ...
                        text: TextSpan(
                          text:
                              'Morning verse ${morningDescription.isNotEmpty ? morningDescription : 'Focus on the Journey, Not the Outcome'}',
                        ),
                      ),
                      RichText(
                        overflow: TextOverflow.visible,
                        text: TextSpan(
                          text:
                              'Evening verse ${eveningDescription.isNotEmpty ? eveningDescription : 'Focus on the Journey, Not the Outcome'}',
                        ),
                      ),
                      // SingleChildScrollView(
                      //   child: Center(
                      //     child: ListView.builder(
                      //       itemCount: morningDescriptions.length,
                      ...
                      // child: Center(
                      //   child: ListView.builder(
                      //     itemCount: eveningDescriptions.length,
                      //     itemBuilder: (context, index) {
                      //       return Text(
